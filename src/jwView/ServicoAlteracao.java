		...
		editar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					int i = JOptionPane.showOptionDialog(null, "Serviço Atualizado Com Sucesso !!\n Deseja Imprimir ?",
		...
		deletar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i = JOptionPane.showOptionDialog(null,
						"Atenção está Prestes a deletar um registro de Serviço\n Tem certeza disto?", "Informação",
				...
				if (i == 0) {
					...
					dao1.delete(servico);
					JOptionPane.showMessageDialog(null, "Serviço Deletado com Sucesso ", "Informação",
